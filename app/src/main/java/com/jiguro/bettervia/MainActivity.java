...
public class MainActivity extends Activity {
  ...
  private static final int UPDATE_SOURCE_VERCEL = 1;
  ...
  private static final int EXPECTED_VERSION_CODE = 20260824;
  private static final String EXPECTED_VERSION_NAME = "2.2.0";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (isAutoUpdateEnabled() && isAutoUpdateDueToday()) {
      new Thread(
              new Runnable() {
                @Override
                public void run() {
  ...
  private void showLanguageSelectionDialog() {
    ...
    final String[] languages = {
      getString(R.string.auto_select),
  ...
  private void showAgreementDialog() {
    final Dialog agreementDialog =
        new Dialog(this, android.R.style.Theme_Light_NoTitleBar_Fullscreen);
  ...
  public void setLauncherIconVisible(boolean visible) {
    ...
    try {
      ...
      String message =
          visible ? getString(R.string.toast_icon_shown) : getString(R.string.toast_icon_hidden);
  ...
  private void refreshLauncher() {
    try {
      String[] actions = {
        "com.android.launcher3.action.REFRESH_LAUNCHER",
        "miui.intent.action.REFRESH_LAUNCHER",
  ...
  private void setupWebViewBackground() {
    try {
      ...
      flowWebView.setOnTouchListener(
  ...
  private void initViews() {
    ...
    if (blogLinkText != null) {
      blogLinkText.setOnClickListener(
          new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              openBlog();
    ...
    if (emailLinkText != null) {
      emailLinkText.setOnClickListener(
          new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              sendEmail();
  ...
  private void showPopupMenu(View view) {
    ...
    if (toggleIconItem != null) {
      toggleIconItem.setTitle(
          isIconHidden ? getString(R.string.show_icon) : getString(R.string.hide_icon));
    }
  ...
  private void showWithdrawAgreementDialog() {
    AlertDialog.Builder builder = new AlertDialog.Builder(this);
    builder
        .setTitle(getString(R.string.withdraw_agreement_title))
        .setMessage(getString(R.string.withdraw_agreement_message))
        .setPositiveButton(
            getString(R.string.withdraw_confirm),
            new DialogInterface.OnClickListener() {
              @Override
              public void onClick(DialogInterface dialog, int which) {
                withdrawAgreement();
        ...
        .setNegativeButton(
            getString(R.string.withdraw_cancel),
            new DialogInterface.OnClickListener() {
              @Override
              public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
  ...
  private void openGitHub() {
    try {
      Intent intent =
          new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/JiGuroLGC/BetterVia"));
      startActivity(intent);
    } catch (Exception e) {
  ...
  private void openGitee() {
    try {
      Intent intent =
          new Intent(Intent.ACTION_VIEW, Uri.parse("https://gitee.com/JiGuro/BetterVia"));
      startActivity(intent);
    } catch (Exception e) {
  ...
  private boolean isAutoUpdateDueToday() {
    try {
      String today =
          new SimpleDateFormat("yyyyMMdd", Locale.US).format(new Date(TimeProvider.now()));
      SharedPreferences sp = getSharedPreferences(SP_NAME, MODE_PRIVATE);
      String lastCheckDate = sp.getString(KEY_LAST_AUTO_UPDATE_DATE, "");
      if (today.equals(lastCheckDate)) {
        return false;
      }
      sp.edit().putString(KEY_LAST_AUTO_UPDATE_DATE, today).apply();
      return true;
    } catch (Exception e) {
      return true;
    }
  ...
  private int getCurrentUpdateSource() {
    SharedPreferences sp = getSharedPreferences(SP_NAME, MODE_PRIVATE);
    return sp.getInt(KEY_UPDATE_SOURCE, UPDATE_SOURCE_VERCEL);
  }
            ...
            new Runnable() {
              ...
              public void run() {
                try {
                  ...
                  String updateUrl =
                      (updateSource == UPDATE_SOURCE_GITHUB)
                          ? GITHUB_UPDATE_URL
                          : VERCEL_UPDATE_URL;
  ...
  private void showUpdateSettingsDialog() {
    ...
    if (giteeOption != null) {
      giteeOption.setOnClickListener(
          new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              updateSourceGroup.check(R.id.gitee_radio);
            ...
            new DialogInterface.OnClickListener() {
              ...
              public void onClick(DialogInterface dialog, int which) {
                ...
                if (selectedId == R.id.github_radio) {
                  ...
                  selectedSource = UPDATE_SOURCE_VERCEL;
                } else {
  ...
  private void showUpdateDialog(final UpdateInfo info) {
    AlertDialog.Builder builder = new AlertDialog.Builder(this);
    builder
        .setTitle(String.format(getString(R.string.new_version_found), info.versionName))
            ...
            new DialogInterface.OnClickListener() {
              ...
              public void onClick(DialogInterface dialog, int which) {
                try {
                  ...
                  Toast.makeText(
                          MainActivity.this,
                          getString(R.string.cannot_open_download_link),
                          Toast.LENGTH_SHORT)
                      .show();
                }
              }
  ...
  private void showUpdateCheckFailed() {
    runOnUiThread(
        new Runnable() {
          ...
          public void run() {
            Toast.makeText(
                    MainActivity.this, getString(R.string.update_check_failed), Toast.LENGTH_SHORT)
                .show();
          }
        });
  }
  ...
  private void showSecurityFixDialog() {
    new AlertDialog.Builder(this)
        .setTitle(getString(R.string.security_fix_dialog_title))
  ...
  public void onRequestPermissionsResult(
    ...
    if (requestCode == REQUEST_STORAGE_PERMISSION_FOR_FIX) {
      if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
        ...
        if (hasRootPermission()) {
          ...
          Toast.makeText(this, getString(R.string.security_fix_need_permission), Toast.LENGTH_LONG)
              .show();
        }
      }
      return;
    ...
    TamperResponseHelper.onRequestPermissionsResult(
        this,
        requestCode,
        permissions,
        grantResults,
                    ...
                    new Runnable() {
                      ...
                      public void run() {
                        if (result) {
                          Toast.makeText(
                                  MainActivity.this,
                                  getString(R.string.security_fix_success),
                                  Toast.LENGTH_LONG)
                              .show();
                        } else {
                          Toast.makeText(
                                  MainActivity.this,
                                  getString(R.string.security_fix_no_issue),
                                  Toast.LENGTH_SHORT)
                              .show();
                        }
                      }
                    ...
                    new Runnable() {
                      ...
                      public void run() {
                        if (result) {
                          ...
                          Toast.makeText(
                                  MainActivity.this,
                                  getString(R.string.security_fix_suggest_root),
                                  Toast.LENGTH_LONG)
                              .show();
                        } else {
                          Toast.makeText(
