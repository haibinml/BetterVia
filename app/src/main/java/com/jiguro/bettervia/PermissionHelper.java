...
public class PermissionHelper {
  ...
  public static void requestRootPermission(
      final Context context, final PermissionCallback callback) {
    new Thread(
            new Runnable() {
              public void run() {
                            ...
                            SharedPreferences.Editor ed =
                                context
                                    .getSharedPreferences(
                                        MainActivity.SP_NAME, Context.MODE_PRIVATE)
                                    .edit();
                            if (finalGranted) {
                              Toast.makeText(
                                      context,
                                      context.getString(R.string.root_permission_granted),
                                      Toast.LENGTH_SHORT)
                                  .show();
                              ...
                              Toast.makeText(
                                      context,
                                      context.getString(R.string.root_permission_denied),
                                      Toast.LENGTH_SHORT)
                                  .show();
  ...
  public static void resetPermissionStatus(Context context) {
    context
        .getSharedPreferences(MainActivity.SP_NAME, Context.MODE_PRIVATE)
        .edit()
